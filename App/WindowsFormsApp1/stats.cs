...
namespace WindowsFormsApp1
{
    class Stats
    {
        ...
        {
            string query = "SELECT type, name, sell_price, stock, department, min_stock FROM `products`";
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    prodlist.Add(new Product(reader["type"].ToString(), reader["name"].ToString(), Convert.ToDouble(reader["sell_price"]), Convert.ToInt32(reader["stock"]), Convert.ToInt32(reader["min_stock"]), d));
                }
